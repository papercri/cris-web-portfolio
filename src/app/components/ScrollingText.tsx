  ...
  return (
    <>
      ...
      <div className="w-full overflow-hidden bg-transparent select-none">
        <div className={`${shouldReduceMotion ? 'flex flex-wrap justify-center' : 'marquee-track'} text-foreground text-[90vh] md:text-[140cqh] font-extrabold tracking-wide items-center leading-[70%] uppercase`}>
